...
public partial class CurrentRound : PanelContainer
{
    ...
    private Task ReceiveNextTurnMessage(IMessage message)
    {
        ...
        _valueToUpdate.Enqueue(turnDoneMessage.Value.RoundNumber.ToString()); // have to do this because this isn't run on the main thread
